...
class Generator(torch.nn.Module):
    def __init__(self):
        ...
        self.module_2 = py_nndct.nn.Linear(in_features=100, out_features=6400, bias=True) #Generator::Generator/Linear[net_noise]/1645
        self.module_3 = py_nndct.nn.Module('reshape') #Generator::Generator/1651
        self.module_4 = py_nndct.nn.Linear(in_features=4, out_features=1024, bias=True) #Generator::Generator/Linear[net_label]/1652
        self.module_5 = py_nndct.nn.Module('reshape') #Generator::Generator/1658
        self.module_6 = py_nndct.nn.Cat() #Generator::Generator/1661
        self.module_7 = py_nndct.nn.Module('permute') #Generator::Generator/1667
        ...
        self.module_12 = py_nndct.nn.Conv2d(in_channels=64, out_channels=64, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=True) #Generator::Generator/Sequential[net]/ResBlock[2]/Sequential[block]/Conv2d[2]/1728
        self.module_13 = py_nndct.nn.Add() #Generator::Generator/Sequential[net]/ResBlock[2]/input.13
        self.module_14 = py_nndct.nn.ReLU(inplace=False) #Generator::Generator/Sequential[net]/ResBlock[2]/1732
        ...
        self.module_19 = py_nndct.nn.Conv2d(in_channels=128, out_channels=128, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=True) #Generator::Generator/Sequential[net]/ResBlock[5]/Sequential[block]/Conv2d[2]/1793
        self.module_20 = py_nndct.nn.Add() #Generator::Generator/Sequential[net]/ResBlock[5]/input.23
        self.module_21 = py_nndct.nn.ReLU(inplace=False) #Generator::Generator/Sequential[net]/ResBlock[5]/1797
        ...
        self.module_26 = py_nndct.nn.Conv2d(in_channels=256, out_channels=256, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=True) #Generator::Generator/Sequential[net]/ResBlock[8]/Sequential[block]/Conv2d[2]/1858
        self.module_27 = py_nndct.nn.Add() #Generator::Generator/Sequential[net]/ResBlock[8]/input.33
        self.module_28 = py_nndct.nn.ReLU(inplace=False) #Generator::Generator/Sequential[net]/ResBlock[8]/1862
        ...
        self.module_33 = py_nndct.nn.Conv2d(in_channels=128, out_channels=128, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=True) #Generator::Generator/Sequential[net]/ResBlock[11]/Sequential[block]/Conv2d[2]/1923
        self.module_34 = py_nndct.nn.Add() #Generator::Generator/Sequential[net]/ResBlock[11]/input.43
        self.module_35 = py_nndct.nn.ReLU(inplace=False) #Generator::Generator/Sequential[net]/ResBlock[11]/1927
        ...
        self.module_40 = py_nndct.nn.Conv2d(in_channels=64, out_channels=64, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=True) #Generator::Generator/Sequential[net]/ResBlock[14]/Sequential[block]/Conv2d[2]/1988
        ...
        self.module_44 = py_nndct.nn.Hardsigmoid(inplace=False) #Generator::Generator/Sequential[net]/Hardsigmoid[16]/2012
        self.module_45 = py_nndct.nn.strided_slice() #Generator::Generator/2017
    ...
    def forward(self, *args):
        ...
        output_module_38 = self.module_45(input=output_module_38, dim=[0,1,2,3], start=[0,0,0,0], end=[9223372036854775807,9223372036854775807,256,256], step=[1,1,1,1])
